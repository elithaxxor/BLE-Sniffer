...
def start_gui():
    def start_scanning():
        ...
        scan_thread.start()
        messagebox.showinfo("Info", "Scanning started!")

    def stop_scanning():
        # This is a simple way to stop the scanning loop
        os._exit(0)
    ...
    stop_button = Button(root, text="Stop Scanning", command=stop_scanning)
